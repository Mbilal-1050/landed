...
export default function AiUpgradeRequired({ tool }: { tool: string }) {
  return (
    <div className="rounded-2xl border border-amber/30 bg-amber/5 p-10 text-center">
      ...
      <h2 className="font-display text-xl text-fog">AI {tool} is a Pro feature</h2>
      <p className="mx-auto mt-2 max-w-sm text-sm text-fog-dim">
        Upgrade to a paid plan to unlock AI-generated resumes, cover letters, and summaries —
        each plan includes a monthly generation allowance.
      </p>
      <Link
        href="/pricing"
